...
#define CapSense_BUTTON_UP__BTN        (1u)
#define CapSense_BUTTON_DOWN__BTN        (2u)
...
#define CapSense_POS_FILTERS_MASK        (4u)
#define CapSense_LINEAR_SLIDERS_POS_FILTERS_MASK        (4u)
