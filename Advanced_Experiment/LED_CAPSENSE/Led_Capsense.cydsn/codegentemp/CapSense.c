...
uint8 CYXDATA * const CYCODE CapSense_pcTable[] = {
    (uint8 CYXDATA *)CapSense_PortCH0__Button_Up__BTN__PC, 
    (uint8 CYXDATA *)CapSense_PortCH0__Button_Down__BTN__PC, 
...
const uint8 CYCODE CapSense_portTable[] = {
    CapSense_PortCH0__Button_Up__BTN__PORT, 
    CapSense_PortCH0__Button_Down__BTN__PORT, 
...
const uint8 CYCODE CapSense_maskTable[] = {
    CapSense_PortCH0__Button_Up__BTN__MASK,
    CapSense_PortCH0__Button_Down__BTN__MASK,
