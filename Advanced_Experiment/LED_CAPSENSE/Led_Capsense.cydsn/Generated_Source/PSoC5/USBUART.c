...
*    State                      |Description
*    ---------------------------|----------------------------------------------
*    USBUART_FORCE_J   | Force a J State onto the D+/D每 lines
*    USBUART_FORCE_K   | Force a K State onto the D+/D每 lines
*    USBUART_FORCE_SE0 | Force a Single Ended 0 onto the D+/D每 lines
